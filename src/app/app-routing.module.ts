...
const routes: Routes = [
  ...
  {path:'detailtr/:id', component:ListTrainingComponent},
  ...
  {path:'detailcer/:id', component:ListCertificatComponent},
  ...
  {path:'detailfile/:id', component:ListFileComponent},
  ...
  {path:'detailq/:id', component:ListQuestionComponent},
  {path:'addevent', component:AddEventComponent},
  {path:'updateevent/:id', component:UpdateEventComponent},
  {path:'delevent/:id', component:DeleteEventComponent},
  {path:'detailevent/:id', component:ListEventComponent},
